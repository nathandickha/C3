...
export function snapToPool(spa) {
  ...
  // Keep the existing snap position logic, but ensure the 0.05m top-offset
  // slider state is treated as channel-enabled even when the pre-snap distance
  // still classifies the spa as inner-flush.
